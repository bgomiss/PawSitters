...
struct SideFilterMenu_Previews: PreviewProvider {
    static var previews: some View {
        ...
        SideFilterMenu(selectedTab: .constant(1), isExpanded: true, location: .constant("manhattan"), selectedDateRange: .constant(startDate...endDate), environment: .constant("Urban"))
    }
}
